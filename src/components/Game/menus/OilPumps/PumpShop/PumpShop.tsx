...
import style from './PumpShop.module.css';
...
export default class PumpShop extends React.Component {
	declare props: Props;
	...
	render(): React.ReactNode {
		...
		{
			goodsList.push(
				<div className={style.element} key={i} style={{
